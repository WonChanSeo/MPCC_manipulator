...
from fk_num import *
import time
from validation_bf16 import Validation
...
for i in range(10):
    ...
    t_mesh = time.time()
    print(f'  NN time (BF16): {t_nn-t0:.2f} s')
    ...
    with open("data_bf16.csv", "ab") as f:
        np.savetxt(f, data.numpy(), delimiter=',', fmt='%4.3f')

print()
print("=" * 60)
print("BF16 inference test completed!")
print("Output saved to: data_bf16.csv")
print("=" * 60)
