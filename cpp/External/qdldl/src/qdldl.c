...
// ADMM iteration tracking for detailed solve logging (defined in qdldl_interface.c)
...
// ADMM solve logging control
void QDLDL_set_admm_iteration(int iter, int sample_id, int enable_logging) {
    g_qdldl_current_admm_iteration = iter;
    g_qdldl_current_sample_id = sample_id;
